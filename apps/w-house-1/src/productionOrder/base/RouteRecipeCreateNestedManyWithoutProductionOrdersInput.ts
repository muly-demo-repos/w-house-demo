...
@InputType()
class RouteRecipeCreateNestedManyWithoutProductionOrdersInput {
...
export { RouteRecipeCreateNestedManyWithoutProductionOrdersInput as RouteRecipeCreateNestedManyWithoutProductionOrdersInput };
